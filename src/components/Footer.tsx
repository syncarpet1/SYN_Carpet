...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black border-t border-yellow-500/20">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-8 flex-1 flex flex-col">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className="bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-lg p-3 text-center">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-8 flex-1 flex flex-col">
              ...
              <ul className="space-y-4 text-white/70 flex-1">
                ...
                <li className="hover:text-yellow-400 transition-colors cursor-pointer flex items-center space-x-3 p-2 rounded-lg hover:bg-white/5">
                  <div className="w-2 h-2 bg-gradient-to-r from-yellow-600 to-amber-500 rounded-full"></div>
      ...
      <a 
        href="http://wa.me/+447949087460"
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full flex items-center justify-center shadow-2xl hover:from-green-600 hover:to-green-700 transition-all transform hover:scale-110 z-50 border-2 border-yellow-500/30"
